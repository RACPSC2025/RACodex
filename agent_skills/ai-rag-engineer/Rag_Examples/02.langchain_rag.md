...
name: langchain-rag
description: |
  Skill especializado en RAG (Retrieval-Augmented Generation) para aplicaciones profesionales.
  Cubre document loaders, embeddings, vector stores, retrieval strategies y reranking.
  Enfoque en precisión, prevención de alucinaciones y rendimiento enterprise.
---

# LangChain RAG Skill

Este skill proporciona conocimiento especializado para construir sistemas RAG profesionales.

## Cuándo Usar Este Skill

Usa este skill cuando el usuario necesite:

- Construir un sistema de Q&A sobre documentos especializados
- Implementar retrieval de documentación técnica, contratos o reportes
- Prevenir alucinaciones en respuestas
- Manejar tablas y estructura compleja en PDFs

...
description: |
  Skill para implementar Human in the Loop (HITL) en agentes profesionales.
  Cubre interrupts, aprobación humana, edición de estado y time travel.
  Esencial para decisiones críticas que requieren supervisión humana.
---

# LangGraph Human in the Loop Skill

Este skill implementa patrones de supervisión humana para agentes profesionales.

## Cuándo Usar Este Skill

Usa este skill cuando necesites:

- Aprobación humana para respuestas críticas
...
- `langgraph-fundamentals` - Para estructura básica del grafo
- `langchain-rag` - Para retrieval con aprobación
